...
Static3D::Static3D(const char *path, std::shared_ptr<Shader> shader, physx::PxTransform modelMatrix)
...
Static3D::Static3D(const Static3D &o, physx::PxTransform modelMatrix)
